...
aliases['nCleanGenJet'] = {
    'linesToAdd': ['.L /afs/cern.ch/user/v/victorr/private/WWcontrol_region/DrellYan/ngenjet.cc+'],
    'class': 'CountGenJet',
...
aliases['getGenZpt_OTF'] = {
    ...
    'linesToAdd': ['.L /afs/cern.ch/user/v/victorr/private/WWcontrol_region/DrellYan/getGenZpt.cc+'],
    'class': 'getGenZpt',
