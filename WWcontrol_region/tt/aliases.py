...
aliases['nCleanGenJet'] = {
    'linesToAdd': ['.L /afs/cern.ch/user/v/victorr/private/WWcontrol_region/tt/ngenjet.cc+'],
    'class': 'CountGenJet',
...
aliases['getGenZpt_OTF'] = {
    ...
    'linesToAdd': ['.L /afs/cern.ch/user/v/victorr/private/WWcontrol_region/tt/getGenZpt.cc+'],
    'class': 'getGenZpt',
