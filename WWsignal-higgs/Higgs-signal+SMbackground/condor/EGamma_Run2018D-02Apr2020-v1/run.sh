...
cp output.root /afs/cern.ch/user/v/victorr/private/WWsignal-higgs/Higgs-signal+SMbackground/rootFiles__darkHiggs2018_v7/mkShapes__darkHiggs2018_v7__ALL__${1}.root
rm output.root
rm script.py
